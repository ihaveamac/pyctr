...
KNOWN_BLOCKS = {
    ...
    0x00050006: (0xC, 0x2),
    0x00050007: (0xC, 0x4),
    0x00050008: (0xC, 0x268),
    0x00050009: (0xC, 0x8),
    0x00060000: (0xC, 0x150),
    0x00070000: (0xE, 0x532),
    0x00070001: (0xE, 0x1),
    0x00070002: (0xE, 0x8),
    0x00080000: (0xC, 0x3072),
    0x00080001: (0xC, 0x3072),
    0x00080002: (0xC, 0x3072),
    0x00090000: (0xE, 0x8),
    0x00090001: (0xE, 0x8),
    0x00090002: (0xE, 0x4),
    0x000A0000: (0xE, 0x28),
    ...
    0x000A0002: (0xE, 0x1),
    0x000B0000: (0xE, 0x4),
    0x000B0001: (0xE, 0x2048),
    0x000B0002: (0xE, 0x2048),
    0x000B0003: (0xE, 0x4),
    0x000C0000: (0xE, 0x192),
    0x000C0001: (0xE, 0x20),
    0x000C0002: (0xE, 0x512),
    0x000D0000: (0xE, 0x4),
    0x000E0000: (0xE, 0x1),
    0x000F0000: (0xC, 0x16),
    0x000F0001: (0xC, 0x8),
...
class ConfigSaveReader:
    ...
    def set_block(self, block_id: int, data: bytes, flags: int = None, *, strict: bool = True):
        ...
        if strict:
            try:
                expected_flags, expected_size = KNOWN_BLOCKS[block_id]
            except KeyError:
                raise
            else:
