...
KNOWN_BLOCKS = {
    0x00000000: {"flags": 0xC, "size": 0x2},
    0x00010000: {"flags": 0xC, "size": 0x1},
    0x00020000: {"flags": 0xC, "size": 0x308},
    0x00030000: {"flags": 0xC, "size": 0x1},
    0x00030001: {"flags": 0xE, "size": 0x8},
    0x00030002: {"flags": 0xC, "size": 0x8},
    0x00040000: {"flags": 0xC, "size": 0x16},
    0x00040001: {"flags": 0xC, "size": 0x28},
    0x00040002: {"flags": 0xC, "size": 0x18},
    0x00040003: {"flags": 0xC, "size": 0x12},
    0x00040004: {"flags": 0xC, "size": 0x28},
    0x00050000: {"flags": 0xC, "size": 0x2},
    0x00050001: {"flags": 0xC, "size": 0x2},
    0x00050002: {"flags": 0xC, "size": 0x56},
    0x00050003: {"flags": 0xC, "size": 0x32},
    0x00050004: {"flags": 0xC, "size": 0x32},
    0x00050005: {"flags": 0xE, "size": 0x32},
    0x00050006: {"flags": 0xC, "size": 0x2},
    0x00050007: {"flags": 0xC, "size": 0x4},
    0x00050008: {"flags": 0xC, "size": 0x268},
    0x00050009: {"flags": 0xC, "size": 0x8},
    0x00060000: {"flags": 0xC, "size": 0x150},
    0x00070000: {"flags": 0xE, "size": 0x532},
    0x00070001: {"flags": 0xE, "size": 0x1},
    0x00070002: {"flags": 0xE, "size": 0x8},
    0x00080000: {"flags": 0xC, "size": 0x3072},
    0x00080001: {"flags": 0xC, "size": 0x3072},
    0x00080002: {"flags": 0xC, "size": 0x3072},
    0x00090000: {"flags": 0xE, "size": 0x8},
    0x00090001: {"flags": 0xE, "size": 0x8},
    0x00090002: {"flags": 0xE, "size": 0x4},
    0x000A0000: {"flags": 0xE, "size": 0x28},
    0x000A0001: {"flags": 0xE, "size": 0x2},
    0x000A0002: {"flags": 0xE, "size": 0x1},
    0x000B0000: {"flags": 0xE, "size": 0x4},
    0x000B0001: {"flags": 0xE, "size": 0x2048},
    0x000B0002: {"flags": 0xE, "size": 0x2048},
    0x000B0003: {"flags": 0xE, "size": 0x4},
    0x000C0000: {"flags": 0xE, "size": 0x192},
    0x000C0001: {"flags": 0xE, "size": 0x20},
    0x000C0002: {"flags": 0xE, "size": 0x512},
    0x000D0000: {"flags": 0xE, "size": 0x4},
    0x000E0000: {"flags": 0xE, "size": 0x1},
    0x000F0000: {"flags": 0xC, "size": 0x16},
    0x000F0001: {"flags": 0xC, "size": 0x8},
    0x000F0003: {"flags": 0xC, "size": 0x1},
    0x000F0004: {"flags": 0xC, "size": 0x4},
    0x000F0005: {"flags": 0xC, "size": 0x4},
    0x000F0006: {"flags": 0xC, "size": 0x40},
    0x00100000: {"flags": 0xC, "size": 0x2},
    0x00100001: {"flags": 0xC, "size": 0x148},
    0x00100002: {"flags": 0xC, "size": 0x1},
    0x00100003: {"flags": 0xC, "size": 0x16},
    0x00110000: {"flags": 0xC, "size": 0x4},
    0x00110001: {"flags": 0xC, "size": 0x8},
    0x00120000: {"flags": 0xC, "size": 0x8},
    0x00130000: {"flags": 0xE, "size": 0x4},
    0x00150000: {"flags": 0xC, "size": 0x4},
    0x00150001: {"flags": 0xC, "size": 0x8},
    0x00150002: {"flags": 0xE, "size": 0x4},
    0x00160000: {"flags": 0xE, "size": 0x4},
    0x00170000: {"flags": 0xE, "size": 0x4},
    0x00180000: {"flags": 0xC, "size": 0x4},
    0x00180001: {"flags": 0xC, "size": 0x24},
    0x00190000: {"flags": 0xC, "size": 0x1},
}
    ...
    def set_block(self, block_id: int, data: bytes, flags: int = None, *, strict: bool = True):
        ...
        if strict:
            try:
                ...
                raise InvalidBlockDataError(f"unknown block_id 0x{block_id:X}")
            else:
                expected_flags = known['flags']
                expected_size = known['size']
                if flags is not None and flags != expected_flags:
                    raise InvalidBlockDataError(f'unexpected flags (0x{expected_flags:x} expected, 0x{flags:x} given)')
                if (data_len := len(data)) != expected_size:
                    raise InvalidBlockDataError(f'unexpected size (0x{expected_size:x} expected, 0x{data_len:x} given)')
